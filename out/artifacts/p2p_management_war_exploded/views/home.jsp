...
<div class="ui grid">
    ...
    <div class="two wide column">
        <div class="ui inverted segment">
            <div class="ui inverted accordion">
                <div class="title">
                    <i class="dropdown icon"></i> <i class="user icon"></i>用户及交易管理
                </div>
    ...
    <div class="fourteen wide white column">
                ...
                <div class="wide  column">
                    <div class="ui tab segment active" data-tab="first">
                        <div class="ui breadcrumb">
                            ...
                            <a class="section">产品列表</a>

                        </div>

                        <div class="btns">
                            <div class="settings">
                                <div onclick="addPro()" class="ui animated green fade button" tabindex="0">
                        ...
                        <div class="items">
                            <table class="ui sortable celled table">
                                ...
                                <tr>
                                    ...
                                    <th colspan="5">产品列表信息</th>
                                    <th><span id="msg"></span></th>
                                </tr>
                                </thead>
                                <tr>
                                    <td>序号</td>
                    ...
                    <div class="ui tab segment" data-tab="thrid">
                        课件
                    </div>
        ...
        <!--aa-->
        <div class="ui tab segment" data-tab="aa">
            个人中心
        </div>
        <!--bb-->
        <div class="ui tab segment" data-tab="bb">
            第八个
        </div>
        <!--cc-->
        <div class="ui tab segment" data-tab="cc">
            第八个
        </div>
        <!--dd-->
        <div class="ui tab segment" data-tab="dd">
            第八个
        </div>
        <!--ee-->
        <div class="ui tab segment" data-tab="ee">
            第八个
        </div>
        <!--ff-->
        <div class="ui tab segment" data-tab="ff">
            第八个
        </div>
        <!--gg-->
        <div class="ui tab segment" data-tab="gg">
            第八个
        </div>
        <!--hh-->
        <div class="ui tab segment" data-tab="hh">
            第八个
        </div>
        <!--ii-->
        <div class="ui tab segment" data-tab="ii">
            第八个
        </div>
        <!--jj-->
        <div class="ui tab segment" data-tab="jj">
            第八个
        </div>
        <!--kk-->
        <div class="ui tab segment" data-tab="kk">
            第八个
        </div>
    </div>
    <!-- 弹出层 -->
    <div class="ui modal">
        ...
        <div class="image content">
            <form class="ui form" id="modalForm">
                <div class="field">
                    <label>产品编号</label>
                    <input type="text" name="proNum" id="proNum" placeholder="请输入产品编号">
                </div>
                <div class="field">
                    <label>产品名称</label>
                    <input type="text" name="proName" id="proName" placeholder="请输入产品名称">
                </div>
                <div class="field">
                    <label>产品期限</label>
                    <input type="text" name="proLimit" id="proLimit" placeholder="请输入产品期限">
                </div>
                <div class="field">
                    <label>产品年利率</label>
                    <input type="text" name="annualized" id="annualized" placeholder="请输入产品年利率">
                </div>
                <div class="field" id="confirmBtn">
                    <input class="ui button" type="button" id="uiButton" value="出错了哦"/>
                </div>
            </form>
        </div>
    </div>
